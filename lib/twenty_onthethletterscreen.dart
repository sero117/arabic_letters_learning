import 'package:arabic_letters_game/twenty_twoethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentyOnthethletterscreen extends StatefulWidget {
  @override
  _TwentyOnthethletterscreenState createState() =>
      _TwentyOnthethletterscreenState();
}

class _TwentyOnthethletterscreenState extends State<TwentyOnthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الحادي والعشرون"),
