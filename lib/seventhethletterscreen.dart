import 'package:arabic_letters_game/eigthethethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Seventhethletterscreen extends StatefulWidget {
  @override
  _SeventhethletterscreenState createState() => _SeventhethletterscreenState();
}

class _SeventhethletterscreenState extends State<Seventhethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف السابع عشر"),
