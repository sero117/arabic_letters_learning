import 'package:arabic_letters_game/eightithletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Seventhletterscreen extends StatefulWidget {
  @override
  _SeventhletterscreenState createState() => _SeventhletterscreenState();
}

class _SeventhletterscreenState extends State<Seventhletterscreen> {
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => Eightithletterscreen(),
                                      ),
                                    );
                                  },
