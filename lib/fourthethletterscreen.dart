import 'package:arabic_letters_game/fifthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Fourthethletterscreen extends StatefulWidget {
  @override
  _FourthethletterscreenState createState() => _FourthethletterscreenState();
}

class _FourthethletterscreenState extends State<Fourthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الرابع عشر"),
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => Fifthethletterscreen(),
                                      ),
                                    );
                                  },
