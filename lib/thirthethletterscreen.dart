import 'package:arabic_letters_game/fourthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Thirthethletterscreen extends StatefulWidget {
  @override
  _ThirthethletterscreenState createState() => _ThirthethletterscreenState();
}

class _ThirthethletterscreenState extends State<Thirthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الثالث عشر"),
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => Fourthethletterscreen(),
                                      ),
                                    );
                                  },
