import 'package:arabic_letters_game/thirthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Twelveletterscreen extends StatefulWidget {
  @override
  _TwelveletterscreenState createState() => _TwelveletterscreenState();
}

class _TwelveletterscreenState extends State<Twelveletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الثاني عشر"),
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => Thirthethletterscreen(),
                                      ),
                                    );
                                  },
