import 'package:arabic_letters_game/twelveletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Elevenletterscreen extends StatefulWidget {
  @override
  _ElevenletterscreenState createState() => _ElevenletterscreenState();
}

class _ElevenletterscreenState extends State<Elevenletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الحادي عشر"),
