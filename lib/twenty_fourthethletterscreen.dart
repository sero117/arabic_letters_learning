import 'package:arabic_letters_game/twenty_fifthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentyFourthethletterscreen extends StatefulWidget {
  @override
  _TwentyFourthethletterscreenState createState() =>
      _TwentyFourthethletterscreenState();
}

class _TwentyFourthethletterscreenState
    extends State<TwentyFourthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الرابع والعشرون"),
