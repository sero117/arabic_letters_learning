import 'package:arabic_letters_game/twenty_eigthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentySeventhethletterscreen extends StatefulWidget {
  @override
  _TwentySeventhethletterscreenState createState() =>
      _TwentySeventhethletterscreenState();
}

class _TwentySeventhethletterscreenState
    extends State<TwentySeventhethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف السابع والعشرون"),
