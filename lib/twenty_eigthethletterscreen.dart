import 'package:arabic_letters_game/Final_celebrationsletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentyEigthethletterscreen extends StatefulWidget {
  @override
  _TwentyEigthethletterscreenState createState() =>
      _TwentyEigthethletterscreenState();
}

class _TwentyEigthethletterscreenState
    extends State<TwentyEigthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الثامن والعشرون"),
