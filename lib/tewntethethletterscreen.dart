import 'package:arabic_letters_game/twenty_onthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Tenthethletterscreen extends StatefulWidget {
  @override
  _TenthethletterscreenState createState() => _TenthethletterscreenState();
}

class _TenthethletterscreenState extends State<Tenthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف العشرون"),
