import 'package:arabic_letters_game/tewntethethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Ninethethletterscreen extends StatefulWidget {
  @override
  _NinethethletterscreenState createState() => _NinethethletterscreenState();
}

class _NinethethletterscreenState extends State<Ninethethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف التاسع عشر"),
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => Tenthethletterscreen(),
                                      ),
                                    );
                                  },
