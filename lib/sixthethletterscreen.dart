import 'package:arabic_letters_game/seventhethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Sixthethletterscreen extends StatefulWidget {
  @override
  _SixthethletterscreenState createState() => _SixthethletterscreenState();
}

class _SixthethletterscreenState extends State<Sixthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف السادس عشر"),
