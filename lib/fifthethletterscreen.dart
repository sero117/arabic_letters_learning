import 'package:arabic_letters_game/sixthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Fifthethletterscreen extends StatefulWidget {
  @override
  _FifthethletterscreenState createState() => _FifthethletterscreenState();
}

class _FifthethletterscreenState extends State<Fifthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الخامس عشر"),
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => Sixthethletterscreen(),
                                      ),
                                    );
                                  },
