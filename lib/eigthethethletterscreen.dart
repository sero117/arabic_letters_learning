import 'package:arabic_letters_game/ninethethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Eightithethletterscreen extends StatefulWidget {
  @override
  _EightithethletterscreenState createState() =>
      _EightithethletterscreenState();
}

class _EightithethletterscreenState extends State<Eightithethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الثامن عشر"),
                                ...
                                TextButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => Ninethethletterscreen(),
                                      ),
                                    );
                                  },
