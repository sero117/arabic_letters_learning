import 'package:arabic_letters_game/twenty_fourthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentythreeethLetterscreen extends StatefulWidget {
  @override
  _TwentythreeethLetterscreenState createState() =>
      _TwentythreeethLetterscreenState();
}

class _TwentythreeethLetterscreenState
    extends State<TwentythreeethLetterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الثالث والعشرون"),
