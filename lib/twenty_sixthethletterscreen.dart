import 'package:arabic_letters_game/twenty_seventhethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentySixthethletterscreen extends StatefulWidget {
  @override
  _TwentySixthethletterscreenState createState() =>
      _TwentySixthethletterscreenState();
}

class _TwentySixthethletterscreenState
    extends State<TwentySixthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف السادس والعشرون"),
