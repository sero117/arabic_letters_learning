import 'package:arabic_letters_game/twenty_sixthethletterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentyFifthethletterscreen extends StatefulWidget {
  @override
  _TwentyFifthethletterscreenState createState() =>
      _TwentyFifthethletterscreenState();
}

class _TwentyFifthethletterscreenState
    extends State<TwentyFifthethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الخامس والعشرون"),
