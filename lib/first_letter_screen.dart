import 'package:arabic_letters_game/SecondLetterScreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class FirstLetterScreen extends StatefulWidget {
  @override
  _FirstLetterScreenState createState() => _FirstLetterScreenState();
}

class _FirstLetterScreenState extends State<FirstLetterScreen> {
  Color selectedColor = Colors.red;
  List<ColoredPoint> brushStrokes = [];

  int strokesSinceLastDialog = 0; // عدد النقاط منذ آخر نافذة
...
<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1000 1000">
  <text x="50%" y="100%" text-anchor="middle" dominant-baseline="central"
                ...
                GestureDetector(
                  onPanUpdate: (details) {
                    setState(() {
                      ...
                      // إذا تجاوز عدد النقاط 150 منذ آخر نافذة → افتح نافذة جديدة
