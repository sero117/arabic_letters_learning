import 'package:arabic_letters_game/twentythreeeth_letterscreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TwentyTwoethletterscreen extends StatefulWidget {
  @override
  _TwentyTwoethletterscreenState createState() =>
      _TwentyTwoethletterscreenState();
}

class _TwentyTwoethletterscreenState extends State<TwentyTwoethletterscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text("الحرف الثاني والعشرون"),
